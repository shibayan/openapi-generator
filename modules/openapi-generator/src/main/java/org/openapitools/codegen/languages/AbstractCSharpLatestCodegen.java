...
public abstract class AbstractCSharpLatestCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractCSharpLatestCodegen.class);

    public AbstractCSharpLatestCodegen() {
        super();
