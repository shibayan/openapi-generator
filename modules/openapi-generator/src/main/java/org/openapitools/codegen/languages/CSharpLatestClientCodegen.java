...
public class CSharpLatestClientCodegen extends AbstractCSharpLatestCodegen {
    ...
    public CSharpLatestClientCodegen() {
        super();
        ...
        embeddedTemplateDir = templateDir = "csharp-latest";
