...
namespace Example
{
    public class TestEnumParametersExample
    {
        public static void Main()
        {
            ...
            config.BasePath = "http://petstore.swagger.io:80/v2";
            var apiInstance = new FakeApi(config);
            var enumHeaderStringArray = enumHeaderStringArray_example;  // IReadOnlyList<string>? | Header parameter enum test (string array) (optional) 
            var enumHeaderString = enumHeaderString_example;  // string? | Header parameter enum test (string) (optional)  (default to -efg)
            var enumQueryStringArray = enumQueryStringArray_example;  // IReadOnlyList<string>? | Query parameter enum test (string array) (optional) 
            var enumQueryString = enumQueryString_example;  // string? | Query parameter enum test (string) (optional)  (default to -efg)
            var enumQueryInteger = 56;  // int? | Query parameter enum test (double) (optional) 
            var enumQueryDouble = 1.2D;  // double? | Query parameter enum test (double) (optional) 
            var enumFormStringArray = new IReadOnlyList<string>(); // IReadOnlyList<string>? | Form parameter enum test (string array) (optional)  (default to $)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **enumHeaderStringArray** | **IReadOnlyList&lt;string&gt;?**| Header parameter enum test (string array) | [optional] 
 **enumHeaderString** | **string?**| Header parameter enum test (string) | [optional] [default to -efg]
 **enumQueryStringArray** | **IReadOnlyList&lt;string&gt;?**| Query parameter enum test (string array) | [optional] 
 **enumQueryString** | **string?**| Query parameter enum test (string) | [optional] [default to -efg]
 **enumQueryInteger** | **int?**| Query parameter enum test (double) | [optional] 
 **enumQueryDouble** | **double?**| Query parameter enum test (double) | [optional] 
 **enumFormStringArray** | [**IReadOnlyList&lt;string&gt;?**](string.md)| Form parameter enum test (string array) | [optional] [default to $]
...
> void TestInlineAdditionalProperties(IDictionary<string, string> requestBody)
...
namespace Example
{
    public class TestInlineAdditionalPropertiesExample
    {
        public static void Main()
        {
            ...
            config.BasePath = "http://petstore.swagger.io:80/v2";
            var apiInstance = new FakeApi(config);
            var requestBody = new IDictionary<string, string>(); // IDictionary<string, string> | request body
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **requestBody** | [**IDictionary&lt;string, string&gt;**](string.md)| request body | 
...
> void TestQueryParameterCollectionFormat(IReadOnlyList<string> pipe, IReadOnlyList<string> ioutil, IReadOnlyList<string> http, IReadOnlyList<string> url, IReadOnlyList<string> context)
...
namespace Example
{
    public class TestQueryParameterCollectionFormatExample
    {
        public static void Main()
        {
            ...
            config.BasePath = "http://petstore.swagger.io:80/v2";
            var apiInstance = new FakeApi(config);
            var pipe = new IReadOnlyList<string>(); // IReadOnlyList<string> | 
            var ioutil = new IReadOnlyList<string>(); // IReadOnlyList<string> | 
            var http = new IReadOnlyList<string>(); // IReadOnlyList<string> | 
            var url = new IReadOnlyList<string>(); // IReadOnlyList<string> | 
            var context = new IReadOnlyList<string>(); // IReadOnlyList<string> | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pipe** | [**IReadOnlyList&lt;string&gt;**](string.md)|  | 
 **ioutil** | [**IReadOnlyList&lt;string&gt;**](string.md)|  | 
 **http** | [**IReadOnlyList&lt;string&gt;**](string.md)|  | 
 **url** | [**IReadOnlyList&lt;string&gt;**](string.md)|  | 
 **context** | [**IReadOnlyList&lt;string&gt;**](string.md)|  | 
