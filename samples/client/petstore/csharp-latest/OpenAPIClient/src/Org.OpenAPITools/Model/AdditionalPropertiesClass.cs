...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AdditionalPropertiesClass :  IEquatable<AdditionalPropertiesClass>, IValidatableObject
    {
        ...
        public AdditionalPropertiesClass(IDictionary<string, string>? mapString = default, IDictionary<string, decimal>? mapNumber = default, IDictionary<string, int>? mapInteger = default, IDictionary<string, bool>? mapBoolean = default, IDictionary<string, IReadOnlyList<int>>? mapArrayInteger = default, IDictionary<string, IReadOnlyList<object>>? mapArrayAnytype = default, IDictionary<string, IDictionary<string, string>>? mapMapString = default, IDictionary<string, IDictionary<string, object>>? mapMapAnytype = default, object? anytype1 = default, object? anytype2 = default, object? anytype3 = default)
        {
