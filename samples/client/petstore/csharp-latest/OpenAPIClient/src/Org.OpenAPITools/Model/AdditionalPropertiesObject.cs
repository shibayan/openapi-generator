...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdditionalPropertiesObject : Dictionary<string, IDictionary<string, object>>,  IEquatable<AdditionalPropertiesObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalPropertiesObject" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        public AdditionalPropertiesObject(string? name = default) : base()
        {
            this.Name = name;
        }
