...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class XmlItem :  IEquatable<XmlItem>, IValidatableObject
    {
        ...
        public XmlItem(string? attributeString = default, decimal? attributeNumber = default, int? attributeInteger = default, bool? attributeBoolean = default, IReadOnlyList<int>? wrappedArray = default, string? nameString = default, decimal? nameNumber = default, int? nameInteger = default, bool? nameBoolean = default, IReadOnlyList<int>? nameArray = default, IReadOnlyList<int>? nameWrappedArray = default, string? prefixString = default, decimal? prefixNumber = default, int? prefixInteger = default, bool? prefixBoolean = default, IReadOnlyList<int>? prefixArray = default, IReadOnlyList<int>? prefixWrappedArray = default, string? namespaceString = default, decimal? namespaceNumber = default, int? namespaceInteger = default, bool? namespaceBoolean = default, IReadOnlyList<int>? namespaceArray = default, IReadOnlyList<int>? namespaceWrappedArray = default, string? prefixNsString = default, decimal? prefixNsNumber = default, int? prefixNsInteger = default, bool? prefixNsBoolean = default, IReadOnlyList<int>? prefixNsArray = default, IReadOnlyList<int>? prefixNsWrappedArray = default)
        {
        ...
        public IReadOnlyList<int>? WrappedArray { get; set; }
        ...
        public IReadOnlyList<int>? NameArray { get; set; }

        /// <summary>
        /// Gets or Sets NameWrappedArray
        /// </summary>
        [DataMember(Name = "name_wrapped_array", EmitDefaultValue = false)]
        public IReadOnlyList<int>? NameWrappedArray { get; set; }
        ...
        public IReadOnlyList<int>? PrefixArray { get; set; }

        /// <summary>
        /// Gets or Sets PrefixWrappedArray
        /// </summary>
        [DataMember(Name = "prefix_wrapped_array", EmitDefaultValue = false)]
        public IReadOnlyList<int>? PrefixWrappedArray { get; set; }
        ...
        public IReadOnlyList<int>? NamespaceArray { get; set; }

        /// <summary>
        /// Gets or Sets NamespaceWrappedArray
        /// </summary>
        [DataMember(Name = "namespace_wrapped_array", EmitDefaultValue = false)]
        public IReadOnlyList<int>? NamespaceWrappedArray { get; set; }
        ...
        public IReadOnlyList<int>? PrefixNsArray { get; set; }

        /// <summary>
        /// Gets or Sets PrefixNsWrappedArray
        /// </summary>
        [DataMember(Name = "prefix_ns_wrapped_array", EmitDefaultValue = false)]
        public IReadOnlyList<int>? PrefixNsWrappedArray { get; set; }
