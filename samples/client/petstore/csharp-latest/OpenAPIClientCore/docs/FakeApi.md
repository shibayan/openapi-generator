...
> void TestInlineAdditionalProperties(IDictionary<string, string> param)
...
namespace Example
{
    public class TestInlineAdditionalPropertiesExample
    {
        public static void Main()
        {
            ...
            config.BasePath = "http://petstore.swagger.io:80/v2";
            var apiInstance = new FakeApi(config);
            var param = new IDictionary<string, string>(); // IDictionary<string, string> | request body
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **param** | [**IDictionary&lt;string, string&gt;**](string.md)| request body | 
