...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdditionalPropertiesArray : Dictionary<string, IReadOnlyList<object>>,  IEquatable<AdditionalPropertiesArray>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalPropertiesArray" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        public AdditionalPropertiesArray(string? name = default) : base()
        {
            this.Name = name;
        }
