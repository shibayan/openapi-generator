...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TypeHolderDefault :  IEquatable<TypeHolderDefault>, IValidatableObject
    {
        ...
        public TypeHolderDefault(string stringItem = "what", decimal numberItem = default, int integerItem = default, bool boolItem = true, IReadOnlyList<int> arrayItem = default)
        {
