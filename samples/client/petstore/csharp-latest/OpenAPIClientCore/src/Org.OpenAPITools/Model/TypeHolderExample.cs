...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TypeHolderExample :  IEquatable<TypeHolderExample>, IValidatableObject
    {
        ...
        public TypeHolderExample(string stringItem = default, decimal numberItem = default, float floatItem = default, int integerItem = default, bool boolItem = default, IReadOnlyList<int> arrayItem = default)
        {
        ...
        public IReadOnlyList<int> ArrayItem { get; set; }
